  ...
  <body>
    ...
    <div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
      <div class="navbar-header">
        ...
        <a class="navbar-brand visible-xs" style="font-size:0.95em;" href="http://newcombny.com" target="_blank_">Newcomb, NY</a>
        <a class="navbar-brand hidden-xs" href="http://newcombny.com" target="_blank_" >Newcomb, NY</a>
      </div>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown">
            ...
            <ul class="dropdown-menu">
              ...
              <li><a href="#" data-toggle="collapse" data-target=".navbar-collapse.in" onclick="map.setView([43.97,-74.14],14); return false;"><i class="fa fa-arrows-alt"></i>&nbsp;&nbsp;Hamlet of Newcomb</a></li>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                      ...
                      <br>
                      <p>If you are viewing this through the town of Newcomb's website and would like view this map as a stand-alone webpage <a href="http://frontierspatial.com/adkwebmaps/newcombMap.php" target="_blank_">click here</a>.  </p>
                      <br><br>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                  ...
                  <div class="row clearfix">
                  	...
                  	<p><strong>APA Land Classes</strong><br>
   ...
   <script src="//rawgithub.com/domoritz/leaflet-locatecontrol/gh-pages/src/L.Control.Locate.js" ></script>
    ...
    <!-- LAYERS -->
        ...
        <script type="text/javascript" src="assets/js/newcombMap.js"></script>
