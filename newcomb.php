    ...
    <div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
      <div class="navbar-header">
        ...
        <button type="button" class="btn btn-default navbar-btn"  >
            <li class=" nav dropdown" style="text-align:left;" >
              <a id="toolsDrop" href="#" role="button" class="dropdown-toggle" data-toggle="dropdown" style="color: black;"><i class="fa fa-globe"></i>&nbsp;&nbsp;Zooms <b class="caret"></b></a>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                      ...
                      <p>If you'd like to see this map as a stand-alone webpage <a href="http://frontierspatial.com/adkwebmaps/newcombMap.php" target="_blank_">click here</a>.  </p>
